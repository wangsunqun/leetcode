...
public class Num1053 {
    public static int[] prevPermOpt1(int[] arr) {
        ...
        for (int i = arr.length - 1; i > 0; i--) {
            for (int j = i - 1; j >= 0; j--) {
                if (arr[i] == arr[j]) continue break1;
